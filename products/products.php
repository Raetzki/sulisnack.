...
switch (end($uri)) {
    case 'termekek':
        ...
        if(!empty($_GET["kategoria"]) && empty($_GET["min"]) && empty($_GET["max"])){
            ...
            $min_kat_alapjan_SQL = "SELECT nev, leiras, foto, ar FROM termek WHERE kategoria = ? AND ar >= ?";
            ...
            $max_kat_alapjan_SQL = "SELECT nev, leiras, foto, ar FROM termek WHERE kategoria = ? AND ar <= ?";
            ...
            $min_alapjan_SQL="SELECT nev, leiras, foto, ar FROM termek WHERE ar >= ? ";
            ...
            $max_alapjan_SQL="SELECT nev, leiras, foto, ar FROM termek WHERE ar <= ? ";
